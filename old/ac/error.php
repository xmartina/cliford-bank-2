...
<head>
    ...
    <!-- Title -->
    <title>Funds Transfer Status | Huntington Bank</title>
...
<!-- ##### BILL PAYMENT AREA ###### -->
	 ...
	 <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Funds Transfer</h4>
                            </div>
                            <div class="content">
                                <center style="border:1px solid #C6180D">
								<br/>
								<br/>
								<b id="" style="color:#C6180D">Please contact and pay a fee to the Huntington Bank live chat to confirm your transactions.</b><br/>
								<b id="" style="color:#C6180D">So you can receive the transaction against money laudering.</b>
								<br/>
								<br/>
                                <div style="">					
					
                                    <img src="img/service-null.png" alt="Loading" width="100px"/><br><br>
                                    <img src="img/loading.svg" alt="Loading" width="100px"/>
                                </div>
								</center><br><br>
