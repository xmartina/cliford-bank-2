...
<form method="post" action="#">
	...
	<table cellspacing="0" cellpadding="0"><tbody><tr><td width="90%" align="center"><div style="border-radius:2px;border:2px solid brown; background-color: #222; background-repeat: no-repeat; background-align: center; color: #FFF; padding: 4px; font-weight: bolder; text-align: center;font-size: 13px;margin-left:1px;">ACTIVATE</div></td></tr></tbody></table>
						<select name="activated" id="activated" >
			<option value="yes"><?php echo $row['username']; ?></option>
		</select>
						<div class="clear"></div>
	</div>
	<div align="left" class="form-control w3ls-end">
						<input name="submit" type="submit" class="btn" value="Enable">
						<div class="clear"></div>
	</div>
</form>
</div>
