...
echo "<tr><td>" . $row["account"]. "</td><td><a href='view-code.php?id=" . $row["id"]. "' class='adminnav'>View</a></td><td><a href='e-code.php?id=" . $row["id"]. "' class='adminnav'>Edit</a></td><td><a href='del-code.php?id=" . $row["id"]. "' class='adminnav'>Delete</a></td></tr>";
}
echo "</table>";
