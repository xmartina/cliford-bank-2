...
<html lang="en-US" prefix="og: http://ogp.me/ns#">
	...
	<title>Accounts | MidFirst Bank</title>
    <style>
...
echo "<tr><td>" . $row["username"]. " <font color='red'>" . $row["activated"]. "</font></td><td><a href='edit-account.php?id=" . $row["id"]. "' class='adminnav'>Update</a></td><td><a href='del-account.php?id=" . $row["id"]. "' class='adminnav'>Del</a></td><td><a href='enable.php?id=" . $row["id"]. "' class='adminnav'>AC</a><td><a href='disable.php?id=" . $row["id"]. "' class='adminnav'>DA</a></td></td></tr>";
}
echo "</table>";
