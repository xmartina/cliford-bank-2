...
<html lang="en-US" prefix="og: http://ogp.me/ns#">
	...
	<title>Admin Dashboard | Huntington Bank</title>
    <style>
...
<div class="admin-content">
		...
		<?php endif ?><table><tbody><tr><td><img src="../img/mfb.png" width="50" height="50"></td> <td><?php  if (isset($_SESSION['user'])) : ?><strong><div style="text-transform:uppercase;"><?php echo $_SESSION['user']['username']; ?></div></strong><small><i style="color: #888;">(<?php echo ucfirst($_SESSION['user']['user_type']); ?>)</i></small><?php endif ?></td></tr></tbody></table>
			...
			<p><a class="adminnav" href="codes"><i class="fa fa-fw fa-unlock-alt"></i> Codes</a></p>
			<p><a class="adminnav" href="../logout"><i class="fa fa-fw fa-sign-out"></i> <font color="red">Logout</font></a></p>
			<p><a class="adminnav" href="create-account"><i class="fa fa-fw fa-user-plus"></i> Account</a></p>
			<p><a class="adminnav" href="pincode"><i class="fa fa-fw fa-key"></i> Account Pin</a></p>
			<p><a class="adminnav" href="transactions"><i class="fa fa-fw fa-spinner"></i> Transactions</a></p>
			<p><a class="adminnav" href="img/"><i class="fa fa-fw fa-file-image-o"></i> Profile Photo</a></p>
			<p><a class="adminnav" href="add-transaction">+ <i class="fa fa-fw fa-spinner"></i> Transaction</a></p>
			<p><a class="adminnav" href="ben-details"><i class="fa fa-fw fa-user-md"></i> Client Details</a></p>
			<p><a class="adminnav" href="accounts"><i class="fa fa-fw fa-cogs"></i> Account SetUP</a></p>
			<p><a class="adminnav" href="../account-overview"><i class="fa fa-fw fa-user"></i> Account Overview</a></p>
</div>
</body>
