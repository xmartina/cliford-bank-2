...
<html lang="en-US" prefix="og: http://ogp.me/ns#">
	...
	<title>Transactions | MidFirst Bank</title>
    <style>
...
echo "<tr><td>" . $row["transid"]. "</td><td>" . $row["userid"]. "</td><td><a href='view-transact.php?transid=" . $row["transid"]. "' class='adminnav'>V</a></td><td><a href='e-transact.php?id=" . $row["id"]. "' class='adminnav'>E</a></td><td><a href='del-transact.php?id=" . $row["id"]. "' class='adminnav'>D</a></td></tr>";
}
echo "</table>";
} else { echo "<div style='margin:2px 1px 2px 5px;padding:3px;border:1px solid #222;background:red;font-weight:bold;text-align:center;color:#fff;'>No Generated Codes</div>"; }
$conn->close();
?>
</tbody>
</table>
