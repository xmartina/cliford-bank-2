...
<head>
    ...
    <!-- Title -->
    <title>Financial Advisory | Huntington Bank</title>
                    ...
                    <div class="breadcrumb-content">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Financial Advisory</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="section-heading text-center mb-100">
                        ...
                        <h2>Work with a winning team</h2>
						
                    </div>
                </div>
            </div>
				<h3>Full-fledged execution and clearing</h3>
					<p>In Financial Advisory, our team has advised on landmark Mergers & Acquisitions (M&A) transactions across industries in the United States of America. We will guide you through the entire M&A process as we engage potential acquirers or targets, undertake valuation of businesses, advise on negotiation strategies, terms and structures as well as provide fairness opinions. We are also able to complement our M&A services with our Specialty Finance services which offer leverage financing, bridging loans and guarantees in support of M&A and capital market activities.</p>

					<h3>Benefits</h3>
					<ul>
						<li>>>Help you with the acquisition and disposal of businesses/assets and sourcing new investors including the valuation of securities, managing the due diligence process and negotiation tactics in both domestic and cross-border M&A transactions</li>
						<li>>>Expertise to undertake balance sheet management type of assignments such as financial restructuring, capital structure optimization and financial modelling</li>
					</ul>
