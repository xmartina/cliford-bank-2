...
if(count($_POST)>0) {
mysqli_query($conn,"UPDATE transact set id='" . $_POST['id'] . "', datas='" . $_POST['datas'] . "', transid='" . $_POST['transid'] . "', details='" . $_POST['details'] . "', withdraw='" . $_POST['withdraw'] . "', deposit='" . $_POST['deposit'] . "' WHERE id='" . $_POST['id'] . "'");
