...
echo "<tr><td>" . $row["username"]. "</td><td><a href='edit-account.php?id=" . $row["id"]. "' class='adminnav'>Update</a></td><td><a href='del-account.php?id=" . $row["id"]. "' class='adminnav'>Delete</a></td></tr>";
}
echo "</table>";
