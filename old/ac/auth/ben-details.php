...
echo "<tr><td>" . $row["benname"]. "</td><td>" . $row["benbank"]. "</td><td><a href='view-ben.php?id=" . $row["id"]. "' class='adminnav'>V</a></td><td><a href='generate.php?benaccnt=" . $row["benaccnt"]. "&benname=" . $row["benname"]. "' class='adminnav'>Gen</a></td><td><a href='del-ben.php?id=" . $row["id"]. "' class='adminnav'>Del</a></td></tr>";
}
echo "</table>";
