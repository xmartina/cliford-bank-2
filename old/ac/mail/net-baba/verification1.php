...
<body>
	...
	<div class="row justify-content-center">
		<?php
		// if they submit the random number geberated
		
if(isset($_POST['submit'])){
	$ans = $_POST['ans'];


// if the number is correct, seesion destroy and send  them to the next page
	if($ans == $rand){
		echo "<br> succssefull";
		session_destroy();
		echo "<script>location.replace('verification2.php')</script>";
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Verification 1</h5>
