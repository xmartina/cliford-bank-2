...
<head>
    ...
    <!-- Title -->
    <title>Futures Trading | Huntington Bank</title>
        ...
        <div class="container">
            <div class="row">
				...
				<h3>Full-fledged execution and clearing</h3>
					<p>We offer full-fledged execution and clearing services for all Oklahoma Cities (OC); Oklahoma Exchange Limited; Denver Futures Exchange & United States Exchanges, products, serving retail, institutional and corporate clients across the region. As a part of our services we also offer comprehensive futures research reports.</p>

					<h3><i>Online Trading</i></h3>
					<p>Our leading online trading platform with cutting-edge tools allows you to monitor, execute and manage trades in real time. Our online and mobile trading facilities also allows flexibility and efficient connections to platforms of your choice such as CQG, PAT System J-Trader and N2N. We also offer Direct Market Access (DMA) for our Institutional clients via CME Globex.</p>
					
					<h3><i>Night Desk Support</i></h3>
					<p>Our Foreign Market Trading Desk assists you during global trading hours, offering you with crucial convenience for futures trading during the night.</p>
