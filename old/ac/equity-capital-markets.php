...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="Huntington Bank offers a full range of personal, business, commercial, trust, private banking and mortgage banking products and online services.">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <!-- The above 4 meta tags *must* come first in the head; any other head content must come *after* these tags -->

    <!-- Title -->
    <title>Equity Capital Markets | Huntington Bank</title>
                    ...
                    <div class="breadcrumb-content">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Equity Capital Markets</li>
                            </ol>
                        </nav>
                    </div>
                </div>
    ...
    <section class="services-area section-padding-100-0">
        <div class="container">
            <div class="row">
				...
				<h3>The fund-raising support you need</h3>
					<p>Our Equity Capital Markets (ECM) department provides advice and support in the origination, structuring, pricing, and underwriting of equity fund raising transactions such as initial public offerings, private placements and rights issues.

						ECM also manages syndication, marketing and distribution of equity offerings through a quality network of institutional, corporate, high net-worth and retail clients. The department also assists you with price stabilisation activities for IPOs and manages investor relations, both prior to and after an equity fund raising transaction.</p>

					<h3>Benefits</h3>
					<ul>
						<li>>>We have a team of dedicated, experienced ECM professionals who have a proven track record in delivering results in a wide range of equity offerings, from small and mid-cap placements to landmark IPO transactions</li>
						<li>>>RHB's integrated service offering, which connects the CIBS coverage bankers with the corporate finance team, the ECM team and the sales network</li>
					</ul>
