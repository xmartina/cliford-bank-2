				...
				<div class="hvrbox">
					...
					<div class="loginbox">
						<div class="innerlogin" id="login-form">
							 ...
							 <form class="form-horizontal" id="acclogin" enctype="multipart/form-data" action="customer_2fa.php" method="post">
							     <h3>INTERNET BANKING</h3>
								  <div id="login"><div class="errorMessage" align="center"><?php echo $errorMessage; ?></div>
	
								  <div class="form-group">
								    <div class="col-sm-10">
									<span id="spry_pin"> 
								      <input class="form-control" name="accpin" type="password" id="accpin" maxlength="20" autocomplete="off" maxlength="20" placeholder="2FA PIN">
