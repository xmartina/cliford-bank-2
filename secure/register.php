	...
	<div class="container">
		...
		<div class="card-single-wr">
			...
			<div class="tkl">
				...
				<div class="tab">
				  <button class="tablinks" onclick="openCity(event, 'London')" id="defaultOpen">Online Registration</button>
				  <button class="tablinks">Terms & Condition</button>
				  <button class="tablinks">User Information</button>
				  <button class="tablinks">Completed</button>
				</div>
              ...
              <p>Get more with <?php echo $site_title; ?> Sign up for now.</p>
