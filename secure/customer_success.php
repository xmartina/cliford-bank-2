		...
		<div class="card-single-wr">
			...
			<div class="tkl">
				...
				<div class="tab">
				  ...
				  <button class="tablinks" onclick="openCity(event, 'Completed')" id="defaultOpen">Completed</button>
				</div>
          ...
          <div id="form-total">
			            ...
			            <h2>
			            	...
			            	<span class="step-text">Congratulations</span>
			            </h2>
			            <section style="width:100%; align:center;">
			                <div class="inner">
							  ...
							  <table>
                                         ...
                                         <p>Dear <strong style="color:green;">Customer,</strong> Your account has been created successfully, 
                                         you can login to you account.</p>
                    		  <p>Please you will have to wait till Our Customer Service validate your account, this is to enable you carry out transactions on your account. This Process can take <strong style="color:green;">1-2 business working days</strong>, once your account is validated, you will be notify through your registered 
                    		  email address</p>
                    		  <p>A details of the Registration has been sent your email address including the <strong style="color:orange;"><?php echo $site_title; ?> 10 Digit Account </strong>
                    		  Number and other information</p>                 
                                                             </td>
                                                </tr>
                                                
                                             <tr>
                                                 <td>Account Status: <strong style="color:green;">Active</strong></td>
                                             </tr>
            				 ...
            				 <p><strong>Helen Mathew J. (M.Sc) FMT.</strong> </p>
