...
$sql = "SELECT u.id, u.fname, u.lname, u.msg, a.acc_no
     ...
     <ul class="body-tabs body-tabs-layout tabs-animated body-tabs-animated nav">
                            <li class="nav-item">
                                <a role="tab" class="nav-link active" id="tab-0" data-toggle="tab" href="#tab-content-0">
                                    <span>List of Customer Notifications </span>
                                </a>
                            </li>
             ...
             <div class="tab-content">
                            <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
                                <div class="main-card mb-3 card">
                                    <div class="card-body"><h5 class="card-title">Send Direct Messages to User Dashboard</h5>
...
?>
  <tr class="<?php echo $class; ?>"> 
   ...
   <td class="text-center"><a  class="btn btn-success"   href="<?php echo WEB_ROOT; ?>backend/notice/?view=notice&userId=<?php echo $id; ?>"><?php echo $msg; ?></a></td>
