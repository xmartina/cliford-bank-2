...
function modifyEmail()
{
	...
	$sql   = "UPDATE tbl_users 
	          SET fname = '$fname', lname = '$lname', email = '$email', phone = '$phone', dob = '$dob', bname = '$bname', boccu = '$boccu',
	          currency = '$currency', gender = '$gender', empname = '$empname', emptype = '$emptype', salary = '$salary'
