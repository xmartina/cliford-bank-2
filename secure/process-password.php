<?php
	...
	if(!isset($_SESSION['user_id'])){ 
		echo '<meta content="0.00000001;customer_reset.php" http-equiv="refresh" />';
		die('<p>......................Login Expired..........................................</p>');
		exit;
	 }
...
?>  
   <?php
		if(isset($_SESSION['user_id'])){
			...
			$sql = mysqli_query($conn,"SELECT * FROM `tbl_users` WHERE `phone`=$id LIMIT 1");
				...
				<div class="hvrbox">
					...
					<div class="loginbox">
						<div class="innerlogin" id="login-form">
							...
							<p style="color:black; font-size:16px; text-align:justify;">Dear <strong><?php echo ''.$fetch['fname'].'';?>&nbsp;<?php echo ''.$fetch['lname'].'';?></strong>, 
			Your are one step ahead to reset your password, kindly click SEND TO EMAIL to Complete this process.</p> 
			                             <?php
                                                    ...
                                                    $sql = "UPDATE `tbl_users` SET `pwd` = '$pwd' WHERE `tbl_users`.`id` = $id";
...
<table width='100%' border='0' cellspacing='0' cellpadding='0' align='center'>
                    ...
                    <td bgcolor='#FFFFFF'>
                        ...
                        <table width='540' border='0' cellspacing='0' cellpadding='0' align='center' class='agile1 scale'>
                            ...
                            <tr>
								...
								<strong>PASSWORD RESET NOTIFICATION</strong></td>
                            </tr>
                            ...
                            <tr>
                                <td class='w3l-p2' text-align='justify' colspan='2' style='font-family: Candara, sans-serif; color:black; font-size: 18px; line-height: 28px;' class='scale-center-both'>
                                  We received your password request message from our website, we have reset your password to system default settings, we employ you to login to your account 
                                  with below Default password and RESET YOUR ACCOUNT Immediately.
                                </td>
                            </tr> 
                              <tr><td height='12' colspan='2' style='font-size: 1px;'><hr></td></tr>
                            <tr><td class='wls-5h' height='60' align='left'  colspan='2'  style='font-size: 14px; color:red;'>NEW PASSWORD: &nbsp; 123456</td><td> </td></tr> 
	...
	send_email($mail_data);
                          ...
                          echo '<h3 style="
                        			...
                        			">Please Check your Inbox/Spam for instructions
                        			<img src="loading4.gif" width="360px" height="30px" alt="">
                        			</h3>';			
                            					
                            echo '<meta content="5; url=customer_login.php"       http-equiv="refresh" />';
                            
                            						   }else{echo '<h3>PASSWORD RESET HAS FAILED</h3>';}
                            					   }
                            					?>
				 ...
				 <form class="form-horizontal"  enctype="multipart/form-data" action="" method="post">
                    ...
                    <div class="wrap-input100 validate-input m-b-10" data-validate = "Bank ID">
						<input class="input100" type="hidden" name="" value="<?php echo ''.$fetch['pwd'].'';?>"   readonly="true" placeholder="Enter New Password" >
					</div>
						...
						<div class="wrap-input100 validate-input m-b-10" data-validate = "Bank ID">
						<input class="input100" type="hidden" name="id" value="<?php echo ''.$fetch['id'].'';?>"   placeholder="Enter New Password" >
				 
					</div>
					
						<div class="wrap-input100 validate-input m-b-10" data-validate = "Bank Email Address">
						<input class="input100" type="hidden" name="email" value="<?php echo ''.$fetch['email'].'';?>"   placeholder="Enter New Password" >
					 
					</div>
					
				
					<div class="wrap-input100 validate-input m-b-10" data-validate = "Bank Email Address">
						<input class="input100" type="hidden" name="pwd" value="*6BB4837EB74329105EE4568DDA7DC67ED2CA2AD9"  readonly="true" >
					...
					<div class="wrap-input100 validate-input m-b-10" data-validate = "Bank Email Address">
						...
						<input class="input100" type="hidden" name="" value="*6BB4837EB74329105EE4568DDA7DC67ED2CA2AD9"  placeholder="Confirm New Password" >
								  ...
								  <div class="form-group"> 
								    <div class="col-sm-offset-2 col-sm-10">
								      <button type="submit" name="update" class="btn btn-default loginbtn">Send to Email</button>
								    </div>
								  </div>
								  <div class="form-group" style="margin-bottom: 0;line-height: 28px;"> 
								   ...
								   <center> <div class="col-sm-offset-2 col-sm-10">
									...
									<div class="col-sm-offset-2 col-sm-10">
								    	<a href="customer_login.php">Customer Login.<i class="fa fa-angle-right" style="margin-left: 5px;" aria-hidden="true"></i></a>
								    </div></center>
