				...
				<div class="hvrbox">
					...
					<div class="loginbox">
						...
						if(isset($_POST['login'])){
							...
							$sql = mysqli_query($conn,"SELECT `phone` FROM `tbl_users` WHERE `phone`=$phone LIMIT 1");
							...
							if(mysqli_num_rows($sql)>0){
								...
								echo '<meta content="4; url=process-password.php"       http-equiv="refresh" />';
                        			echo '<h3 style="
                        			 color:white;
                            		  padding: 10px;
                        			...
                        			">We are Initiating Password Reset Loading.....
								  ...
								  echo "<h3 style='
										   ...
										   '>Customer Mobile Number Not Found</h3>"; 
							   }
						   }
				?>		
                    
                    
                    <div class="wrap-input100 validate-input m-b-10" data-validate = "Bank phone Address">
						<input class="input100" type="hidden" > 
								  ...
								  <div class="form-group">
								    <div class="col-sm-10" data-validate = "Bank phone Address">
									<span id="sprytextfield1" style="text-align:left;">
								      <input class="form-control" name="phone" type="text" id="acc_no" autocomplete="off" maxlength="20" placeholder="Enter Registered Mobile Number">
								  ...
								  <div class="form-group"> 
								    <div class="col-sm-offset-2 col-sm-10">
								      <button type="submit" name="login" class="btn btn-default loginbtn">Reset Password</button>
								    </div>
								  </div>
