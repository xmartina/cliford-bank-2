            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Same Bank Transfer</h4>
                  
                </div>
				
                <div class="card-body">
				<h4 class="card-title">Please fill out the  Transfer Form</h4>
                <br>&nbsp;<br/>
				 <form action="<?php echo WEB_ROOT; ?>view/process4.php?action=transfer" method="POST"  enctype="multipart/form-data">
                            
							<div class="form-row">
                                <div class="col-md-6">
                                    <div class="position-relative form-group"><label for="exampleEmail11" class="">Beneficiary Bank Account</label>
                                   <br>
                             ...
                             <div class="form-row">
                                ...
                                <div class="col-md-6">
                                    <div class="position-relative form-group"><label for="examplePassword11" class="">Amount to Transfer (<?php echo $_SESSION['hlbank_user']['currency'] ?>):</label>
                            ...
                            <input name="description  style="height:80px;" id="exampleAddress"  type="text" class="form-control" required="required"></div>
