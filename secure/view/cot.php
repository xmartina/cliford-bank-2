...
<div class="container-fluid">
 ...
 you will need Cost of Transfer Code from our customer service to complete your transactions.</p>
		...
		<input type="hidden" value=" <?php echo $_SESSION['hlbank_user_name'];  ?>
         ...
         <?php  echo $_SESSION['rbname'] ; ?>
		 <?php  echo $_SESSION['rstate'] ; ?>, 
		 <?php  echo $_SESSION['rcountry'] ; ?>
	...
	if(isset($_POST['submit'])){
                    		...
                    		$sql = mysqli_query($conn,"SELECT `cot` FROM `tbl_users` WHERE `cot`=$cot LIMIT 1");
                    		
                    		if(mysqli_num_rows($sql)>0){
                    			
                    			 #$_SESSION['user'] = $user;
                    			 $_SESSION['user_id'] = $cot;
			 
			echo '<meta content="20; url=?v=tax"       http-equiv="refresh" />';
			echo '<h4 style="color:white;
                            		padding: 10px;
                                      ...
                                      border-radius:10px;
                                      font-size:16px;
                                      font-weight:700;">You have entered a Correct COT Code, PLease Wait a moment</h4>';
		            ...
		            echo '<h4 style="color:white;
                            		padding: 10px;
                                      ...
                                      font-weight:700;
                    		            ...
                    		            ">  The COT Code you entered is Invalid, Contact Your Account Officer</h4>';
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <textarea class="form-control" rows="5" name="cot" placeholder="Enter COT Code" required=""></textarea>
                          </div>
                        </div>
                      </div>
                    </div>
...
<input type="hidden" name="saccno" value="<?php echo $_SESSION["saccno"]; ?> "/>		
                    ...
                    <button id="submitButton" type="submit" name="submit" class="btn btn-primary pull-right">Validate COT</button>
